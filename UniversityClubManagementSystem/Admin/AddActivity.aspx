<%@ Page Title="Add Activity" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddActivity.aspx.cs" Inherits="UniversityClubManagementSystem.AddActivity" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2 class="page-title">Add Activity</h2>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <asp:Button ID="btnSave" runat="server" Text="Save Activity" CssClass="btn btn-success me-2" OnClick="btnSave_Click" />
